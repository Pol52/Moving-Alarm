cordova.define("cordova-plugin-hypertrack.HyperTrack", function(require, exports, module) { var exec = require('cordova/exec');
var hypertrack = {}
...
// Method to start mock tracking.
hypertrack.startMockTracking = function(success, error) {
    exec(success, error, "HyperTrack", "startMockTracking", [])
};


// Method to stop mock tracking.
hypertrack.stopMockTracking = function(success, error) {
    exec(success, error, "HyperTrack", "stopMockTracking", [])
};
