...
var RingtoneSelectorPageRoutingModule = /** @class */ (function () {
    function RingtoneSelectorPageRoutingModule() {
    }
    ...
    return RingtoneSelectorPageRoutingModule;
}());
...
var RingtoneSelectorPageModule = /** @class */ (function () {
    function RingtoneSelectorPageModule() {
    }
    ...
    return RingtoneSelectorPageModule;
}());
...
var RingtoneSelectorPage = /** @class */ (function () {
    function RingtoneSelectorPage(settings, ringtone, storage) {
    ...
    RingtoneSelectorPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.ringtone.getRingtones()];
                    case 1:
                        _a.ringtonesList = _b.sent();
                        this.selectedRingtone = this.settings.getAlarmRingtone();
                        this.ringtonesList.forEach(function (value, index) {
                            if (value.Name == _this.selectedRingtone.Name) {
    ...
    RingtoneSelectorPage.prototype.updateRingtone = function (ringtone, index) {
        this.playRingtonePreview(ringtone.Url);
        this.selected = index;
        this.settings.setAlarmRingtone(ringtone);
    };
    RingtoneSelectorPage.prototype.playRingtonePreview = function (ringtoneUrl) {
        this.ringtone.playRingtonePreview(ringtoneUrl);
    };
    RingtoneSelectorPage.prototype.ngOnDestroy = function () {
        this.storage.setItem('selectedRingtone', this.ringtonesList[this.selected]);
    };
    RingtoneSelectorPage.ctorParameters = function () { return [
...
//# sourceMappingURL=ringtone-selector-ringtone-selector-module-es5.js.map