...
let MapPage = class MapPage {
    constructor(loadingCtrl, alertCtrl, storage, router, alarm, position, location, http) {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.internetIsActive().then((isActive) => {
                if (isActive) {
    ...
    loadMap() {
        ...
        this.position.startingCameraPosition().then((startingCameraCoords) => {
            let latLng = new _ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_3__["LatLng"](startingCameraCoords.coords.latitude, startingCameraCoords.coords.longitude);
            let mapOptions = {
                controls: controls,
                camera: {
                    target: latLng,
            ...
            this.map = _ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_3__["GoogleMaps"].create('map_canvas', mapOptions);
    ...
    updateDestination() {
        this.internetIsActive().then((isActive) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (isActive) {
                yield this.presentLoadingWithMessage('Pinpointing destination..');
                this.map.clear();
                yield this.searchInputLocation();
    ...
    presentLoadingWithMessage(message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return new Promise((resolve) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                const loading = yield this.loadingCtrl.create({
                    message: message,
    ...
    searchInputLocation() {
        ...
        return new Promise(resolve => {
            _ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_3__["Geocoder"].geocode(options).then((results) => {
    ...
    setDestinationOnMarkerTap() {
        this.searchedPositionMarker.on(_ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_3__["GoogleMapsEvent"].MARKER_CLICK).subscribe(() => {
            this.showDestinationConfirmationAlert();
        });
    }
    showDestinationConfirmationAlert() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const alert = yield this.alertCtrl.create({
                header: 'Enable Alarm',
    ...
    enableAlarm() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoadingWithMessage("Setting alarm..");
    ...
    checkDestinationHistory(savedDestinations) {
        let destinationFoundInHistory = false;
        let i = 0;
